...
class MTDfEngine(object):
    ...
    def search_controller(self):               # Iterative Deepening Implementation
        """
        ...
        for depth in range(2, self._max_depth + 1):
            if depth % 2 == 0:
                move, guess1, final_board1 = self._mtd(self.board, depth, guess1)
            else:
                move, guess2, final_board2 = self._mtd(self.board, depth, guess2)
